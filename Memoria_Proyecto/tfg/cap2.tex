...
Google App Engine te permite ejecutar tus aplicaciones web en la infraestructura de Google. 
...
que nos proporciona Google Plus, como nombre, apellidos, foto de perfíl, dirección, etc.
...
decidimos que la mejor forma era utilizar la API de Google Drive, para crear documentos de hoja de calculo con la información que le pasara la aplicación, para ello fue necesario
