...
Una de las ventajas del uso de este tipo de base de datos es su escalabilidad, pues estan diseñadas para manejar grandes volumenes de datos. Gracias al modulo QuerySet de Django podemos manipular la informacion en estas bases de datos, 
con las restricciones de no poder usar ``joins'' ni ``many to many'', ni ninguna relacion entre
...
En cuanto al diseño de la aplicacion se utilizan tecnologías CCS y Ajax, introduciendo los frameworks Bootstraps y jQuery que mejoran la usabilidad de la interfaz de usuario y descargan
