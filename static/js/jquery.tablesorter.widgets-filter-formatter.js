...
$.tablesorter.filterFormatter = {
	...
	uiDatepicker: function($cell, indx, defDate) {
		...
		$('<input type="text" name="from" class="dateFrom" style="width: 80px;" placeholder="From" value=""/><input type="text" name="to" class="dateTo" style="width: 80px;" placeholder="To" value=""/>').appendTo($cell);
